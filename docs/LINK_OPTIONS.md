...
|                  | linkComponent          | boolean | true      | <b>Optional</b>. If this is `true`, a link component would be generated for each route.                                                                                                                  |
|                  | redirectComponent      | boolean | true      | <b>Optional</b>. If this is `true`, a redirect component would be generated for each route.                                                                                                              |
|                  | useParams              | boolean | true      | <b>Optional</b>. If this is `true`, `useParams` a helper function would be generated for each route if the route has dynamic path.                                                                       |
|                  | useRedirect            | boolean | true      | <b>Optional</b>. If this is true, `useRedirect` a helper function would be generated for each route.                                                                                                     |
...
|                  | linkComponent          | boolean | true      | <b>Optional</b>. If this is `true`, a link component would be generated for each route.                                                                                                                                           |
|                  | redirectComponent      | boolean | true      | <b>Optional</b>. If this is `true`, a redirect component would be generated for each route.                                                                                                                                       |
|                  | useParams              | boolean | true      | <b>Optional</b>. If this is `true`, a `useParams` helper function would be generated for each route if the route has dynamic path.                                                                                                |
