...
interface TypescriptPatternConfig {
  origin: string;
  routeName: string;
  routePattern: string;
...
class TypescriptPattern extends BasePlugin<TypescriptPatternConfig, [TemplateFile, PatternNamedExports]> {
...
export default TypescriptPattern;
